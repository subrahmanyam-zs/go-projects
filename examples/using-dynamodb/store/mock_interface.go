...
import (
	...
	model "developer.zopsmart.com/go/gofr/examples/using-dynamodb/model"
...
func (m *MockPerson) Create(c *gofr.Context, user model.Person) error {
	m.ctrl.T.Helper()
...
func (m *MockPerson) Get(c *gofr.Context, id string) (model.Person, error) {
	m.ctrl.T.Helper()
...
func (m *MockPerson) Update(c *gofr.Context, user model.Person) error {
	m.ctrl.T.Helper()
