...
import (
	handler "developer.zopsmart.com/go/gofr/examples/data-layer-with-ycql/handlers/shop"
	store "developer.zopsmart.com/go/gofr/examples/data-layer-with-ycql/stores/shop"
