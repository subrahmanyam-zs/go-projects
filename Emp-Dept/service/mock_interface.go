...
func (m *MockEmployee) GetAll(ctx *gofr.Context, name string, include bool) (interface{}, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAll", ctx, name, include)
	ret0, _ := ret[0].(interface{})
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockEmployeeMockRecorder) GetAll(ctx, name, include interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetAll", reflect.TypeOf((*MockEmployee)(nil).GetAll), ctx, name, include)
}
...
func (m *MockEmployee) Put(ctx *gofr.Context, id uuid.UUID, dataToUpdate entities.Employee) (interface{}, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Put", ctx, id, dataToUpdate)
	ret0, _ := ret[0].(interface{})
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockEmployeeMockRecorder) Put(ctx, id, dataToUpdate interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Put", reflect.TypeOf((*MockEmployee)(nil).Put), ctx, id, dataToUpdate)
}
