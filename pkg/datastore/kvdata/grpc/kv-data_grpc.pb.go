...
func (c *genericDataServiceClient) Set(ctx context.Context, in *Data, opts ...grpc.CallOption) (*Result, error) {
	out := new(Result)
...
func (c *genericDataServiceClient) Delete(ctx context.Context, in *Key, opts ...grpc.CallOption) (*Result, error) {
	out := new(Result)
...
func (UnimplementedGenericDataServiceServer) Set(context.Context, *Data) (*Result, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Set not implemented")
}
func (UnimplementedGenericDataServiceServer) Delete(context.Context, *Key) (*Result, error) {
