...
func getAuthContext() string {
	return "bFhON1NFNVJKeVRadVpDVURrWnU5bks2a1JFdm9JWUFyMWpMckROOFdheHFPbFhIV2xTc3VucW5HS2l6LzNnbXd5bW0zSnJWdXI" +
...
func TestCSPAuth(t *testing.T) {
	...
	for i, tc := range tcs {
		...
		req := httptest.NewRequest(http.MethodGet, "/dummy", body)
